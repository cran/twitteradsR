#' fetch_twitterads
#' A function to fetch Twitter Ads data from the windsor.ai API
#'
...
#' @examples
#' \dontrun{
#' my_twitterads_data <- fetch_twitterads(api_key = "your api key",
...
fetch_twitterads <-
  function(api_key,
    ...
    json_data <- jsonlite::fromJSON(
      paste0(
        "https://connectors.windsor.ai/twitter?api_key=",
        api_key,
        "&fields=",
